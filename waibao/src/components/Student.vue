              ...
              >
                <el-sub-menu index="1">
                  ...
                  <el-menu-item-group title="Group One">
                    <el-menu-item index="1-1"><RouterLink :to="{ name: 'StudentClassrooms' }">教室</RouterLink></el-menu-item>
                    <el-menu-item index="1-2"><RouterLink :to="{ name: 'StudentCourse' }">课程</RouterLink></el-menu-item>
                  </el-menu-item-group>
