              ...
              >
                <el-sub-menu index="1">
                  ...
                  <el-menu-item-group title="Group One">
                    <el-menu-item index="1-1"><RouterLink :to="{ name: 'AdminClassrooms' }">教室</RouterLink></el-menu-item>
                    <el-menu-item index="1-2"><RouterLink :to="{ name: 'AdminCourse' }">课程</RouterLink></el-menu-item>
                  </el-menu-item-group>
                  <el-menu-item-group title="Group Two">
                    <el-menu-item index="1-3"><RouterLink :to="{name:'AdminSchedule'}">个人课表</RouterLink></el-menu-item>
                    <el-menu-item index="1-4"><RouterLink :to="{name:'AdminAutoArranging'}">自动排课</RouterLink></el-menu-item>
                  </el-menu-item-group>
